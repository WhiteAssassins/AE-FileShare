...
3. Cambia los usuarios y hashes de `config.php`.
4. Sube los archivos que quieras compartir dentro de `files/`.
5. Asegurate de que PHP pueda escribir en `data/` para registrar descargas.
6. Abre el dominio configurado, por ejemplo `https://file.aewhitedevs.com`.
